<script lang="ts">
    ...
    let invalidDataError = $derived(!clientStateObject.state.sealedFile || gameModule.currentModule === null || gamePenalties.currentPenalties === null || gameProfile.currentProfile === null);
