<script lang="ts">
	...
	import { clientRoleObject, clientStateObject, sessionIDObject, webSocketObject, gameBackground, gameModule, gameModuleIcon, gamePenalties } from "$lib/stateHandler.svelte"
